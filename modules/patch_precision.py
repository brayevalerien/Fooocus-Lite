...
def patched_register_schedule(
    ...
    sigmas = torch.tensor(
        ((1 - alphas_cumprod) / alphas_cumprod) ** 0.5, dtype=torch.float32
    )
...
def patch_all_precision():
    ...
    ldm_patched.modules.model_sampling.ModelSamplingDiscrete._register_schedule = (
