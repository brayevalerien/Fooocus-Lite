...
def process_diffusion(
    ...
    if refiner_swap_method == "separate":
        ...
        if target_model is None:
            ...
            print(
                "Use base model to refine itself - this may because of developer mode."
            )
    ...
    if refiner_swap_method == "vae":
        ...
        noise_mean = torch.mean(
            modules.patch.patch_settings[os.getpid()].eps_record, dim=1, keepdim=True
        )
